...
### Undoing all commits on your local copy of a shared branch 
  ...
  - Like this: **git reset** --**hard origin/master** **(that’s double
    hyphen there)**
...
### git pull
  ...
  - Like this: **git pull remoteRepo maste**r
...
### git reset
  ...
  - Or…
      - Undo all commits since the specified commit, AND reset the
        working directory
          - Like this: **git reset** --**hard \<commitId\> (that’s
            double hyphen there)**
  ...
  - Or…
      ...
      - Like this: **git reset** --**hard origin/master** **(that’s
        double hyphen there)**
  - More here:
