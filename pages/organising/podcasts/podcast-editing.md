...
- Upload the mixed recording to [Temi](https://www.temi.com/) (use the big button on the home page)
    - Create a transcript
- Load the mixed recording into [Audacity](https://www.audacityteam.org/) (I have it installed on my Windows laptop)    
    - Or you can load individual interviewees and line them up so the timing is right
- First get a feel for the broad outline
    - SKIM the transcript
    - Quickly insert headings broadly describing each section
    ...
    - Think about which sections you want to cut
        - This way you won't waste ages listening to tholse sections in detail - you can just ignore them from the start
- Now start inserting timestamped labels in Audacity and Word
    ...
    - Do two passes:
        - On the first, just create an Audacity label + timestamp for each of your broad headings that you inserted before. 
            ...
            - When you number the labels, leave gaps because you will be adidng more granbular labels later
    ...
    - Whenever you reach a point that may mark the start or end of a clip, give it a label (mostly I give them labels like T002, T003, apart from obvious milestones like T001start - which I add text to)
        ...
        - In Word:
            ...
            - Ctrl + Alt + 3 to highlight the label using heading 3 (makes it easier to find later)
                - !! Watch out though! Somehow all my text ended up being in Heading mode, even though it looked "normal" - and I have no idea how it happened. It seemed to happen after I was using Outline mode. I think maybe it happened because I started editing when I was still in Outline mode? Anyway, keep an eye out for this. The quickest way to check whether it's happened is View | Navigation pane and check that all your label headings are appearing separatelu.
